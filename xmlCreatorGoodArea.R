xmlCreator <- function(inPath, zoneFile, tracker, nbParticles, annee, mois, direction, outPath, prefix, xmlName){
  cat('<?xml version="1.0" encoding="Cp1252"?>
<icstructure>
  <long_name>ROMS 3D Ichthyop configuration file</long_name>
  <description>Predefined parameters for ROMS dataset from NetCDF files.</description>
  <version date="2012/11/20">3.2</version>
  <block type="option">
    ...
    <parameters>
      <parameter type="serial">
        ...
        <value>year ',annee,' month ',mois,' day 01 at 00:00</value>
        <format>date</format>
      ...
      <parameter type="serial">
        ...
        <value>0030 day(s) 00 hour(s) 00 minute(s)</value>
      ...
      <parameter hidden="true">
        ...
        <value>year 1958 month 01 day 01 at 00:00</value>
        <format>date</format>
  ...
  <block type="dataset">
    <key>dataset.nemo</key>
    <tree_path>Main/OPA NEMO</tree_path>
    <description>Block of options for managing the hydrodynamic dataset. Pre-defined block for OPA NEMO model, 3D simulation and local NetCDF files. It is assumed that the grid information is split in three distincts files: mask file (x, y, z dimensions and land-ocean mask), zgr file (depth T point, depth W point and e3t), hgr file (e1t, e2t, e1v and e2u variables). If theses fields are all recorded in a single file, it is not a problem, just type the same file pattern for the three files. The application expects to find lon and lat variables in "gridT" files, U and time variables and time dimension in "gridU" files and V variable in "gridV" files. Again, just provide the same file pattern for the three types of files if all the variables are recorded within the same file.</description>
    <parameters>
      <parameter>
        <key>input_path</key>
	...
	<value>',inPath,'</value>
        ...
        <description>Folder containing the NEMO NetCDF files. Relative pathnames are supported. For instance, input or input/ or ./input or ./input/ are equivalent. Notice the application ignores the subfolders.</description>
      </parameter>
      <parameter>
      ...
      <parameter>
        <key>byte_mask_pattern</key>
        <long_name>Mask file pattern</long_name>
        <value>*mask*.nc</value>
        <default>*mask*.nc</default>
        <description>Filename filter for identifying the "mask" NetCDF output file. Accepted metacharacters * (for any String) and ? (for any single character). The application expects to find in this file the dimensions x, y, z and the variable land/ocean mask at T points</description>
      </parameter>
      <parameter>
        <key>field_dim_x</key>
        <long_name>Dimension in the X-direction</long_name>
        <value>x</value>
        <default>x</default>
      ...
      <parameter>
        <key>field_dim_y</key>
        <long_name>Dimension in the Y-direction</long_name>
        <value>y</value>
        <default>y</default>
        <description>Name of the NetCDF dimension in the hydrodynamic dataset.</description>
      </parameter>
      ...
      <parameter>
        <key>field_var_mask</key>
        <long_name>Land/ocean mask at T points</long_name>
        <value>fmask</value>
        <default>fmask</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>gridt_pattern</key>
        <long_name>gridT file pattern</long_name>
        <value>*gridT*</value>
        <default>*gridT*</default>
        <description>Filename filter for identifying the "gridT" NetCDF output files. Accepted metacharacters * (for any String) and ? (for any single character). The application expects to find in these files variables longitude and latitude at T points. It is also assumed that all the additional tracked variables (see section Output/Variable tracking) will be found in these "gridT" files.</description>
      </parameter>
      <parameter>
        <key>field_var_lat</key>
        <long_name>Latitude of Rho points</long_name>
        <value>nav_lat</value>
        <default>nav_lat</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        ...
        <value>nav_lon</value>
        <default>nav_lon</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>hgr_pattern</key>
        <long_name>HGR file pattern</long_name>
        <value>*hgr*.nc</value>
        <default>*hgr*.nc</default>
        <description>Filename filter for identifying the "HGR" NetCDF output file. Accepted metacharacters * (for any String) and ? (for any single character). The application expects to find in this file e1t, e2t, e1v and e2u variables.</description>
      </parameter>
      <parameter>
        <key>field_var_e1t</key>
        <long_name>Zonal scale factor at T points</long_name>
        <value>e1t</value>
        <default>e1t</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>field_var_e2t</key>
        <long_name>Meridional scale factor at T points</long_name>
        <value>e2t</value>
        <default>e2t</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>field_var_e1v</key>
        <long_name>Zonal scale factor at V points</long_name>
        <value>e1v</value>
        <default>e1v</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>field_var_e2u</key>
        <long_name>Meridional scale factor at U points</long_name>
        <value>e2u</value>
        <default>e2u</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>zgr_pattern</key>
        <long_name>ZGR file pattern</long_name>
        <value>*zgr*.nc</value>
        <default>*zgr*.nc</default>
        <description>Filename filter for identifying the "ZGR" NetCDF output file. Accepted metacharacters * (for any String) and ? (for any single character). The application expects to find in this file the variables depth at T points, depth at W points and vertical scale factor at T points.</description>
      </parameter>
      <parameter>
        <key>field_var_e3t</key>
        <long_name>Vertical scale factor at T points</long_name>
        <value>e3t</value>
        <default>e3t_ps</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>field_var_e3u</key>
        <long_name>Vertical scale factor at U points</long_name>
        <value>e3u</value>
        <default>e3u_ps</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>field_var_e3v</key>
        <long_name>Vertical scale factor at V points</long_name>
        <value>e3v</value>
        <default>e3v_ps</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>field_var_gdept</key>
        <long_name>Depth at T points</long_name>
        <value>gdept_0</value>
        <default>gdept</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>field_var_gdepw</key>
        <long_name>Depth at W points</long_name>
        <value>gdepw_0</value>
        <default>gdepw</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>gridu_pattern</key>
        <long_name>gridU file pattern</long_name>
        <value>*gridU*.nc</value>
        <default>*gridU*.nc</default>
        <description>Filename filter for identifying the "gridU" NetCDF output files. Accepted metacharacters * (for any String) and ? (for any single character). The application expects to find in these files the time dimension, the time variable and the zonal velocity variable.</description>
      </parameter>
      <parameter>
        <key>field_dim_time</key>
        <long_name>Dimension in time</long_name>
        <value>time_counter</value>
        <default>time_counter</default>
        <description>Name of the NetCDF dimension in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
      ...
      <parameter>
        ...
        <value>vozocrtx</value>
        <default>vozocrtx</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>gridv_pattern</key>
        <long_name>gridV file pattern</long_name>
        <value>*gridV*.nc</value>
        <default>*gridV*.nc</default>
        <description>Filename filter for identifying the "gridV" NetCDF output files. Accepted metacharacters * (for any String) and ? (for any single character). The application expects to find in these files the meridional velocity variable.</description>
      </parameter>
      <parameter>
        <key>field_var_v</key>
        <long_name>Meridional velocity</long_name>
        <value>vomecrty</value>
        <default>vomecrty</default>
        <description>Name of the NetCDF variable in the hydrodynamic dataset.</description>
      </parameter>
      <parameter hidden="true">
        <key>class_name</key>
        <long_name>Java Class file</long_name>
        <value>org.previmer.ichthyop.dataset.NemoDataset</value>
        <default>org.previmer.ichthyop.dataset.NemoDataset</default>
        <format>class</format>
  ...
  <block type="action">
    ...
    <tree_path>Advanced/Biology/Lethal temperature</tree_path>
    <enabled>false</enabled>
  ...
  <block type="action">
    <key>action.growthDeb</key>
    <tree_path>Advanced/Biology/DebGrowth</tree_path>
    <enabled>false</enabled>
    <description>Block of options for setting up the growth model. It simulates the growth in length of particles depending on water temperature and food. Dynamic Energy Budget is used to compute length.</description>
    <parameters>
      <parameter>
        <key>half_saturation</key>
        <long_name>half_saturation</long_name>
        <value />
        <default>0.1</default>
        <format>float</format>
        <description>Half saturation constant (XK) [mg m3]</description>
      </parameter>
      <parameter>
        <key>max_surf_specific_assimilation_rate</key>
        <long_name>max_surf_specific_assimilation_rate</long_name>
        <value>127.6</value>
        <default>224</default>
        <format>float</format>
        <description>p_A_m ; max. surf. specific assimilation rate [J cm-2 d-1]</description>
      </parameter>
      <parameter>
        <key>max_surf_specific_somatic_maintenance_rate</key>
        <long_name>max_surf_specific_somatic_maintenance_rate</long_name>
        <value>1751</value>
        <default>2282</default>
        <format>float</format>
        <description>p_t; max. surf. specific somatic maintenance rate [J cm-2 d-1]</description>
      </parameter>
      <parameter>
        <key>length_birth</key>
        <long_name>length_birth</long_name>
        <value>0.0031239</value>
        <default>0.003</default>
        <format>float</format>
        <description>L_b; structural length at birth</description>
      </parameter>
      <parameter>
        <key>length_metamorphosis</key>
        <long_name>length_metamorphosis</long_name>
        <value>0.075002</value>
        <default>0.075002</default>
        <format>float</format>
        <description>L_j; structural length metamorphosis</description>
      </parameter>
      <parameter>
        <key>energy_conductance</key>
        <long_name>energy_conductance</long_name>
        <value>0.09305</value>
        <default>0.33</default>
        <format>float</format>
        <description>v_dot; energy conductance</description>
      </parameter>
      <parameter>
        <key>maturity_maintenance_rate_coeff</key>
        <long_name>maturity_maintenance_rate_coeff</long_name>
        <value>0.01686</value>
        <default>0.06303</default>
        <format>float</format>
        <description>k_j; maturity maintenance rate coeff</description>
      </parameter>
      <parameter>
        <key>shape_larva</key>
        <long_name>shape_larva</long_name>
        <value>0.1367</value>
        <default>0.2249</default>
        <format>float</format>
        <description>del_M1; Value of the shape coefficient enable to convert volumetric length  (DEB length) in real length for larvae</description>
      </parameter>
      <parameter>
        <key>shape_adult</key>
        <long_name>shape_adult</long_name>
        <value>0.2527</value>
        <default>0.2704</default>
        <format>float</format>
        <description>del_M2; Value of the shape coefficient enable to convert volumetric length  (DEB length) in real length for larvae</description>
      </parameter>
      <parameter>
        <key>volume_cost_maintenance</key>
        <long_name>volume_cost_maintenance</long_name>
        <value>6.591</value>
        <default>17.9</default>
        <format>float</format>
        <description>p_M, volum maintenance</description>
      </parameter>
      <parameter>
        <key>maturity_birth</key>
        <long_name>maturity_birth</long_name>
        <value>0.2345</value>
        <default>0.7637</default>
        <format>float</format>
        <description>E_b_H; maturity_birth</description>
      </parameter>
      <parameter>
        <key>maturity_larva</key>
        <long_name>maturity_larva</long_name>
        <value>2904</value>
        <default>6902</default>
        <format>float</format>
        <description>E_j_H; maturity_larva</description>
      </parameter>
      <parameter>
        <key>maturity_juvenile</key>
        <long_name>maturity_juvenile</long_name>
        <value>2617000</value>
        <default>969500</default>
        <format>float</format>
        <description>E_y_H; maturity_juvenile</description>
      </parameter>
      <parameter>
        <key>half_saturation_maturity</key>
        <long_name>half_saturation_maturity</long_name>
        <value>5017</value>
        <default>540200</default>
        <format>float</format>
        <description>E_2_H; half_saturation_maturity</description>
      </parameter>
      <parameter>
        <key>allocation_rule</key>
        <long_name>allocation_rule</long_name>
        <value>0.8074</value>
        <default>0.7807</default>
        <format>float</format>
        <description>Energy allocation rule (Kappa)</description>
      </parameter>
      <parameter>
        <key>cost_growth</key>
        <long_name>cost_growth</long_name>
        <value>8593</value>
        <default>8828</default>
        <format>float</format>
        <description>E_g; Cost for growth (Eg) [J cm-3]</description>
      </parameter>
      <parameter>
        <key>Arrhenius_temperature</key>
        <long_name>arrhenius_temperature</long_name>
        <value>6402</value>
        <default>20110</default>
        <format>float</format>
        <description>Arrhenius temperature (T_A) [K]</description>
      </parameter>
      <parameter>
        <key>maturity_puberty</key>
        <long_name>maturity_puberty</long_name>
        <value>26230000</value>
        <default>69490</default>
        <format>float</format>
        <description>Maturity at puberty (E_p_H) [J]</description>
      </parameter>
      <parameter>
        <key>length_hatch</key>
        <long_name>length_hatch</long_name>
        <value>0.002906101</value>
        <default>291</default>
        <format>float</format>
        <description>Structural length at latching (L_h)</description>
      </parameter>
      <parameter>
        <key>drywet_structure</key>
        <long_name>drywet_structure</long_name>
        <value>23.9</value>
        <default>300</default>
        <format>float</format>
        <description>dry-to-wet mass ratios for the structure (d_V)</description>
      </parameter>
      <parameter>
        <key>drywet_reserve</key>
        <long_name>drywet_reserve</long_name>
        <value>525000</value>
        <default>300</default>
        <format>float</format>
        <description>dry-to-wet mass ratios for the reserve (d_E)</description>
      </parameter>
      <parameter>
        <key>molarmass_structure</key>
        <long_name>molarmass_structure</long_name>
        <value>500000</value>
        <default>300</default>
        <format>float</format>
        <description>the molar mass ratios of the structure (w_V) [g Cmol^-1]</description>
      </parameter>
      <parameter>
        <key>molarmass_reserve</key>
        <long_name>molarmass_reserve</long_name>
        <value>0.4</value>
        <default>300</default>
        <format>float</format>
        <description>the molar mass ratios of the reserve (w_E) [g Cmol^-1]</description>
      </parameter>
      <parameter>
        <key>chempot_structure</key>
        <long_name>chempot_structure</long_name>
        <value>0.1</value>
        <default>300</default>
        <format>float</format>
        <description>chemical potentials of the structure (mu_V) [J Cmol^-1]</description>
      </parameter>
      <parameter>
        <key>chempot_reserve</key>
        <long_name>chempot_structure</long_name>
        <value>23.9</value>
        <default>300</default>
        <format>float</format>
        <description>chemical potentials of the reserve (mu_E) [J Cmol^-1]</description>
      </parameter>
      <parameter>
        <key>ref_temp</key>
        <long_name>ref_temp</long_name>
        <value>293.0</value>
        <default>298.65</default>
        <format>float</format>
        <description>Reference temperature (T1) [K]</description>
      </parameter>
      <parameter>
        <key>food_field</key>
        <long_name>food_field</long_name>
        <value>total</value>
        <default>zoo</default>
        <description>The name of the food variable (case sensitive) in the bioenergetic dataset.</description>
      </parameter>
      <parameter>
        <key>temperature_field</key>
        <long_name>temperature_field</long_name>
        <value>temp</value>
        <default>temp</default>
        <description>The name of the temperature variable (case sensitive) in the hydrodynamic dataset.</description>
      </parameter>
      <parameter>
        <key>initial_reserve</key>
        <long_name>Initial reserve [J]</long_name>
        <value>3.4387E-8</value>
        <default>1.37921</default>
        <format>float</format>
        <description>Value of the reserve (E) [J]</description>
      </parameter>
      <parameter hidden="true">
      ...
      <parameter hidden="true">
        <key>class_name</key>
        <long_name>Java Class file</long_name>
        <value>org.previmer.ichthyop.action.DebGrowthAction</value>
        <default>org.previmer.ichthyop.action.DebGrowthAction</default>
        <format>class</format>
        <description>The Java class called by the application to implement this action.</description>
      </parameter>
      <parameter hidden="true">
        <key>E_tracker</key>
        <long_name>Track E, the particle energy reserve</long_name>
        <value>true</value>
        <default>true</default>
        <format>boolean</format>
        <description>If true the application adds a "E" variable in the NetCDF output file.</description>
      </parameter>
      <parameter hidden="true">
        <key>priority</key>
        <long_name>priority</long_name>
  ...
  <block type="action">
    ...
    <parameters>
      ...
      <parameter>
        <key>zone_file</key>
        <long_name>Zone file</long_name>
        <value>cfg/symphonie_zones.xml</value>
        <default>cfg/my_zones.xml</default>
        <format>zonefile</format>
        <template>zone-symphonie.xml</template>
...
</icstructure>', file=xmlName, append=F, sep="")
}


inPath   <- "/home1/datawork/sbonhomm/dataDrakkar"
zoneFile <- "/home1/datahome/sbonhomm/simulation-ichthyop-java16/ichthyop-3.2_src/cfg/indian_ocean_zones_2.xml"
tracker <- "votemper"
nbParticles <- "1000000"


annee       <- 1959:2015
mois        <- sprintf(c(10:12, 1:3), fmt="%02i")
direction   <- c("forward", "backward")
directionN  <- c("Forward", "Backward")

for (year in 1:length(annee)){
  for (month in 1:length(mois)){
    for (mode in 1:length(direction)){
      outPath1   <- paste0("/home/datawork-flopped-nos/simuTale/goodArea/", directionN[mode],"/results")
      prefix1    <- paste("simu", annee[year], mois[month], direction[mode], sep="_")
      xmlName    <- paste0(paste0("/home1/datahome/sbonhomm/simulation-ichthyop-java16/ichthyop-3.2_src/cfg/allSimus/goodArea/",direction[mode]),
                           paste("/simu", annee[year], mois[month], direction[mode], sep="_"),
                           ".xml")
      xmlCreator(inPath      = inPath,
                 zoneFile    = zoneFile,
                 tracker     = tracker,
...
file.remove("/home1/datahome/sbonhomm/simulation-ichthyop-java16/ichthyop-3.2_src/cfg/allSimus/goodArea/forward/simu_2015_12_forward.xml") ### no ocean data after that
